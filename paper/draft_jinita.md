...
- §3.1's "cloud confirmation rate of 25.4%" was investigated (see `experiments/pilot06_local_models/cascade_confirm_rate_note.md`): it reproduces exactly as the confirm rate of the cascade's pre-outage verification batch (99/389) specifically, not the full-cascade rate (403/1,687 = 23.9%). Left unchanged per the reproducibility criterion (a reproducing computation was found), with the ambiguity documented for a future wording pass.
