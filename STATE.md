...
**Stage:** Pilot #1, #2, #1b (+scale-up n=149) DONE → **C3 ROBUST: α=0.587 (CI [0.475, 0.698])**. Next: Pilot #3 (pertegas definisi hate vs profanity di prompt), lalu putuskan vendor mix bulk
